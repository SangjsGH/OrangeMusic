...
public class SearchAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.search_music_item, viewGroup, false);
        ...
        holder.rankingNumber1.setText((position + 1) + "");
        List<Ranking.DataBean.SongListBean.SingerBean> singer = item.getSinger();
        if (singer!=null&&singer.size()!=0){
            holder.rankingSinger1.setText(singer.get(0).getSingerName());
        }
        holder.rankingSongname1.setText(item.getSongName());
    ...
    static class ViewHolder {
        @BindView(R.id.ranking_number1)
        TextView rankingNumber1;
        @BindView(R.id.ranking_songname1)
        TextView rankingSongname1;
        @BindView(R.id.ranking_singer1)
        TextView rankingSinger1;
