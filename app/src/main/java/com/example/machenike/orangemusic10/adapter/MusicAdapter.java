...
public class MusicAdapter extends BaseAdapter {
    ...
    public MusicAdapter(Context context, List<Song> musicList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.titleTv.setText(Common.musicList.get(position).getName());
        viewHolder.artistTv.setText(Common.musicList.get(position).getSinger() + "-" + Common.musicList.get(position).getAlbum());
        viewHolder.albumImgv.setImageBitmap(Common.musicList.get(position).getAlbumBip());
